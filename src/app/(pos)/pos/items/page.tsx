  ...
  return (
    <main className="min-h-svh bg-background">
      ...
      <section className="mx-auto w-full max-w-5xl space-y-5 p-4 sm:p-6 lg:p-8">
        ...
        <PosItemsWorkspace categories={workspace.categories} currencyCode={context.organization.currency_code} discounts={workspace.discounts} items={workspace.initialItems} />
      </section>
    </main>
  );
}
